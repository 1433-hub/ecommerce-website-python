...
class KhaltiVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            'Authorization': 'Key test_secret_key_dc7fa32b03eb46009ed752ce8b932367'
        }
...
class CustomerLoginView(FormView):
    ...
    # form_valid method is type of post method and is available in createview, formview and updateview
    def form_valid(self, form):
...
class ForgotPasswordView(FormView):
    ...
    def form_valid(self,form):
        ...
        user = customer.user
        text_content = 'Please Click the link to reset the password'
...
class AdminRequiredMixin(object):
    def dispatch(self, request, *args, **kwargs):
        if request.user.is_authenticated and Admin.objects.filter(user=request.user).exists():
            ...
            return redirect('/admin-login/?next=/profile/')
        return super().dispatch(request, *args, **kwargs)
